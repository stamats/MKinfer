...
The functions mdplot and mdplot2 can be used to visualize the mean difference (MD) 
of two groups, assuming two normal distributions, either with identical standard 
deviation (SD) or two (different) SDs. In addition, the sensitivity and specificity 
based on the optimal cutoff (Youden's J statistic) are computed [@Boehning2008].

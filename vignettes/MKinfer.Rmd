...
## Introduction  
Package MKinfer includes a collection of functions for inferential statistics 
not available in standard R packages such as computation of various confidence 
intervals (including bootstrapped versions), HSU t-test and multiple imputation 
t-test.
...
also compute bootstrap intervals as well as one-sided intervals.
...
can also compute boostrap intervals as well as one-sided intervals.
...
## Permutation t-Test
One and two sample permutation t-tests with equal or unequal variances in the
two sample case.
```{r}
perm.t.test(1:10, y = c(7:20)) # without bootstrap: P = .00001855
## permutation confidence interval sensitive to outlier!
perm.t.test(1:10, y = c(7:20, 200)) # without bootstrap: P = .1245

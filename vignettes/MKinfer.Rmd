...
## equal variances
dgt(0, n1 = 5, n2 = 10, sd1 = 1, sd2 = 1)
dt(0, df = 5+10-2)

pgt(2, n1 = 5, n2 = 10, sd1 = 1, sd2 = 1)
pt(2, df = 5+10-2)

qgt(0.975, n1 = 5, n2 = 10, sd1 = 1, sd2 = 1)
qt(0.975, df = 5+10-2)

library(ggplot2)
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
    stat_function(fun = function(x) dgt(x, n1 = 5, n2 = 10, sd1 = 1, sd2 = 1), 
...
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
    stat_function(fun = function(x) dgt(x, n1 = 5, n2 = 10, sd1 = 1, sd2 = 5), 
                  n = 101, col = "darkblue", lwd = 1) + 
...
## Traditional interface
with(sleep, t.test(extra[group == 1], extra[group == 2]))
with(sleep, xiao.t.test(extra[group == 1], extra[group == 2]))
## Formula interface
t.test(extra ~ group, data = sleep)
xiao.t.test(extra ~ group, data = sleep)
...
```{r, fig.width=7, fig.height=7}
h0plot(t.test(extra ~ group, data = sleep))
h0plot(xiao.t.test(extra ~ group, data = sleep))
```

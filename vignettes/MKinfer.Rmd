...
## small effect size
mdplot(delta = 0.2, sd1 = 1, sd2 = 1)
## medium effect size
mdplot(delta = 0.5, sd1 = 1, sd2 = 1)
## large effect size
mdplot(delta = 0.8, sd1 = 1, sd2 = 1)
## z-factor = 0  (z-factor = 1 - 3*2*sd/delta)
mdplot(delta = 6, sd1 = 1, sd2 = 1)
## z-factor = 0.5  (z-factor = 1 - 3*2*sd/delta)
mdplot(delta = 12, sd1 = 1, sd2 = 1)
...
res <- sapply(delta, md2sens, sd1 = 1, sd2 = 1)
